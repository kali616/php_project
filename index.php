...
foreach($_SESSION['adminProducts'] as $product){ ?>
   
    <div class="pro">
    <form action="cart.php?index=<?php echo $index++; ?>" method="post">
    <img src="admin/upload/<?php echo $product['imgName'] ?>" alt="p1" />
        <div class="des">
...
<?php
session_start();
include 'inc/lang.php'; // Include language settings
...
<body>
<a href="add_category.php" class="btn btn-secondary">Add Category</a>
